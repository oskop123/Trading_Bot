...
def portfolio_plot(portfolio):
    ...
    ax1.plot(portfolio.loc[portfolio.signal == 1.0].index, portfolio['total'][portfolio.signal == 1.0], '^',
             markersize=10, color='m')
    # Plot exit points
    ax1.plot(portfolio.loc[portfolio.signal == -1.0].index, portfolio['total'][portfolio.signal == -1.0], 'v',
